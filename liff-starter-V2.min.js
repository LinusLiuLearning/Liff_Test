...
function initApp() {
  if ((console.log("LIFF initialized!"), !liff.isLoggedIn())) {
...
function changeType() {
  ...
  removeElements("form-label-group"), initContent(a);
}
function initContent(a) {
  ...
  a ||
    ...
    0 >= document.getElementById("type").selectedIndex &&
      (document.getElementById("type").value = "choose"),
    (b = !1)),
    "yes" == getParameterByName("share") &&
      (document.getElementById("share").checked = !0),
...
function sendLiffMessage() {
  var a = document.getElementById("type").value,
    b = new HttpClient(),
    c = "Unknown",
    d = "https://i.imgur.com/ZD6XFET.png",
    e = "";
  if (
    (liff
      .getProfile()
      .then((a) => {
        (c = a.displayName), (d = a.pictureUrl), (e = a.statusMessage);
      })
      .catch((a) => {
        ...
        contents: {
          ...
          hero: {
            ...
            action: {
              type: "uri",
              uri:
                "line://app/1657022499-njBkN1k3?auto=yes&type=image&downloadUrl=" +
                d +
                "&previewUrl=" +
                d,
            },
            ...
            contents: [
              ...
              },
              {
                ...
                action: {
                  type: "uri",
                  label: "Profile",
                  uri: "line://app/1657022499-njBkN1k3?auto=yes&type=profile",
                },
              },
              { type: "spacer", size: "sm" },
            ],
    ...
    sendMessages([
      { type: "text", text: document.getElementById("text").value },
    ]);
  else if ("sticker" == a)
    sendMessages([
      {
    ...
    ? !0 == document.getElementById("share").checked
      ...
      : (console.info("Start sending message"),
        liff
          .sendMessages(a)
          .then(() => {
            console.info("Success sending message"), liff.closeWindow();
          })
          .catch((a) => {
...
function logoutLiff() {
  liff.isLoggedIn() && (liff.logout(), window.location.reload());
}
...
function removeElements(a) {
  for (
    var b = document.getElementsByClassName(a), c = b.length - 1;
    0 <= c;
    c--
  )
    b[c] &&
